...
//                Kiểm tra đã nhập đủ thông tin chưa
    ...
    public  void Init_DB(){
        ...
        DBhelper.QueryData("create table if not exists reportcard( reportid int, teacherid varchar(30), delidate date,PRIMARY KEY(reportid AUTOINCREMENT), FOREIGN KEY (teacherid) REFERENCES users(teacherid) )");
